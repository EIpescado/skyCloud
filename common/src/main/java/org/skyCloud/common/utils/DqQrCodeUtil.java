 ...
 */
public class DqQrCodeUtil {

	private static final int BLACK = 0xFF000000;
	private static final int WHITE = 0xFFFFFFFF;

	private DqQrCodeUtil() {
	...
	public static void writeInfoToJpgFile(String content, String fileUrl) {
		...
		hints.put(EncodeHintType.CHARACTER_SET, EncodeConsts.UTF_8);
		try {
			BitMatrix bitMatrix = multiFormatWriter.encode(content, BarcodeFormat.QR_CODE, 250, 250, hints);
			File file1 = new File(fileUrl);
			DqQrCodeUtil.writeToFile(bitMatrix, "jpg", file1);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) throws Exception {
		BufferedImage bi = writeInfoToJpgBuff("http://www.baidu.com");
		ImageIO.write(bi, "jpg", new File("d:/cnm.jpg"));
	}
}
