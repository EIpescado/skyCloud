...
public class CodeUtils {
    ...
    public static void main(String[] args) throws Exception{
        String [] ps = new String[]{"123","ABSJK","yuqi前","飒沓sxx11","123249464"};
        System.out.println("074A3ACB2ECCB944EA0BE57537DAB517A2472F1A".length());
        for(String pwd:ps){
            String p1 =sha1Hex(pwd);
            System.out.println(p1);
            System.out.println(p1.length() +  "-" +p1.equals(sha1Hex(pwd)));
        }
    }
